...
然而這些AI是否就真的不會犯一些簡單到連業餘棋手都能指認的錯誤嗎？
在我們的論文中，我們系統性的尋找常用的 AI (KataGo, Leela Zero, ELF, CGI) 會犯錯的盤面。我們方法的靈感來自於 adversarial attack。
...
如果加完無意義的子後，理論上盤面會有一樣的最佳步。因此，如果AI 會下出連業餘棋手都看得出來是錯的步，那我們就算攻擊成功。
